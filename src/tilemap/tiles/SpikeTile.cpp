...
void SpikeTile::render(Buffer& buffer, float x, float y) const {
    ...
    switch (face) {
        ...
        case Face::UP:
            ...
            break;
        case Face::DOWN:
            buffer.add(x).add(y + 0.67f).add(color);
            buffer.add(x + 0.165f).add(y + 1.0f).add(color);
            buffer.add(x + 0.33f).add(y + 0.67f).add(color);
            buffer.add(x + 0.33f).add(y + 0.67f).add(color);
            buffer.add(x + 0.5f).add(y + 1.0f).add(color);
            buffer.add(x + 0.66f).add(y + 0.67f).add(color);
            buffer.add(x + 0.66f).add(y + 0.67f).add(color);
            buffer.add(x + 0.825f).add(y + 1.0f).add(color);
            buffer.add(x + 1.0f).add(y + 0.67f).add(color);
            buffer.add(x).add(y + 0.67f).add(color);
            buffer.add(x + 1.0f).add(y).add(color);
            buffer.add(x + 1.0f).add(y + 0.67f).add(color);
            buffer.add(x).add(y + 0.67f).add(color);
            buffer.add(x + 1.0f).add(y).add(color);
            buffer.add(x).add(y).add(color);
            break;
        case Face::LEFT:
            buffer.add(x + 0.33f).add(y).add(color);
            buffer.add(x).add(y + 0.165f).add(color);
            buffer.add(x + 0.33f).add(y + 0.33f).add(color);
            buffer.add(x + 0.33f).add(y + 0.33f).add(color);
            buffer.add(x).add(y + 0.5f).add(color);
            buffer.add(x + 0.33f).add(y + 0.66f).add(color);
            buffer.add(x + 0.33f).add(y + 0.66f).add(color);
            buffer.add(x).add(y + 0.825f).add(color);
            buffer.add(x + 0.33f).add(y + 1.0f).add(color);
            buffer.add(x + 0.33f).add(y).add(color);
            buffer.add(x + 1.0f).add(y + 1.0f).add(color);
            buffer.add(x + 0.33f).add(y + 1.0f).add(color);
            buffer.add(x + 0.33f).add(y).add(color);
            ...
            break;
        case Face::RIGHT:
            buffer.add(x + 0.67f).add(y).add(color);
            buffer.add(x + 1.0f).add(y + 0.165f).add(color);
            buffer.add(x + 0.67f).add(y + 0.33f).add(color);
            buffer.add(x + 0.67f).add(y + 0.33f).add(color);
            buffer.add(x + 1.0f).add(y + 0.5f).add(color);
            buffer.add(x + 0.67f).add(y + 0.66f).add(color);
            buffer.add(x + 0.67f).add(y + 0.66f).add(color);
            buffer.add(x + 1.0f).add(y + 0.825f).add(color);
            buffer.add(x + 0.67f).add(y + 1.0f).add(color);
            buffer.add(x + 0.67f).add(y).add(color);
            buffer.add(x).add(y + 1.0f).add(color);
            buffer.add(x + 0.67f).add(y + 1.0f).add(color);
            buffer.add(x + 0.67f).add(y).add(color);
